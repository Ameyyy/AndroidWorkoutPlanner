...
public final class SharedPreferenceCompat {
    ...
    public static class EditorCompat {
         ...
         */
        public static Editor putStringSet(
                Editor editor, String key, Set<String> values) {

            return IMPL.putStringSet(editor, key, values);
        }

        public static void tryApply(Editor editor) {
            try {
                editor.apply();
    ...
    public static final class EditorCompatWrapper implements Editor {
         ...
         */
        public EditorCompatWrapper(Editor editor) {
            mEditor = editor;
        }
